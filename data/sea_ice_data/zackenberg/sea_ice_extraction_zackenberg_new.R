...
write.csv(zackenberg_cells, "data/sea_ice_data/zackenberg/zackenberg_cells_new.csv")
save(zackenberg_cells, file = "data/sea_ice_data/zackenberg/zackenberg_cells_new.Rda")
#####
...
# Load cell data (mask)
load("data/sea_ice_data/zackenberg/zackenberg_cells_new.Rda")
...
write.csv(sea_ice_extent, "data/sea_ice_data/zackenberg/zackenberg_sea_ice_extent_new.csv")
save(sea_ice_extent, file = "data/sea_ice_data/zackenberg/zackenberg_sea_ice_extent_new.Rda")
...
load("data/sea_ice_data/zackenberg/zackenberg_sea_ice_extent_new.Rda")
str(sea_ice_extent)
# Let's fix that!

# A quick hack to quickly do the conversion is by loading the CSV isntead
sea_ice_extent <- read.csv("data/sea_ice_data/zackenberg/zackenberg_sea_ice_extent_new.csv")
str(sea_ice_extent)
