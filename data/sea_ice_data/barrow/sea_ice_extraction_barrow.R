...
write.csv(barrow_cells, paste0("data/sea_ice_data/barrow/barrow_cells.csv"))
save(barrow_cells, file = paste0("data/sea_ice_data/barrow/barrow_cells.Rda"))
#####
...
# Load cell data (mask)
load("data/sea_ice_data/barrow/barrow_cells.Rda")
...
write.csv(sea_ice_extent, "data/sea_ice_data/barrow/barrow_sea_ice_extent.csv")
save(sea_ice_extent, file = "data/sea_ice_data/barrow/barrow_sea_ice_extent.Rda")
...
load("data/sea_ice_data/barrow/barrow_sea_ice_extent.Rda")
str(sea_ice_extent)
# Let's fix that!

# A quick hack to quickly do the conversion is by loading the CSV isntead
sea_ice_extent <- read.csv("data/sea_ice_data/barrow/barrow_sea_ice_extent.csv")
str(sea_ice_extent)
