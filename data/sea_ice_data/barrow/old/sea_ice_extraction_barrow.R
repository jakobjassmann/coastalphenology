...
scirpt_path <- "scripts/users/jassmann/phenology/sea_ice_data/barrow/"
site_name <- "barrow"
...
pxiel_area_file <- "/Volumes/Users/jakob/Documents/Ecology/PhD/ShrubHub/scripts/users/jassmann/phenology/sea_ice_data/psn25area_v3.dat"
...
write.csv(barrow_cells, passte0(script_path, "barrow_cells.csv"))
save(barrow_cells, file = passte0(script_path, "barrow_cells.Rda"))
#####
