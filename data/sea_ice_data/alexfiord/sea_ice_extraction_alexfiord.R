...
###
# The cell containing Alex is: x 129 and y 277 !
###
...
alexfiord_cells <- data.frame(cell_id = rep(NA, 2 + 1 + 2 + 2 + 3 + 1 + 2 + 3 + 4), x_grid = rep(0, 20), y_grid = rep(0, 20), lat = rep(0, 20), long = rep(0, 20), size = rep(0, 20))
alexfiord_cells$x_grid <- c(seq(135, 136, 1), 133, seq(127, 128, 1), seq(126, 127, 1), seq(125, 127, 1), 125, seq(124, 125, 1), seq(123, 125, 1), seq(122, 125, 1))
alexfiord_cells$y_grid <- c(rep(276, 2), rep(277, 1), rep(281, 2), rep(282, 2), rep(283, 3), rep(284, 1), rep(285, 2), rep(286, 3),  rep(287, 4))
...
write.csv(alexfiord_cells, paste0("data/sea_ice_data/alexfiord/alexfiord_cells.csv"))
save(alexfiord_cells, file = paste0("data/sea_ice_data/alexfiord/alexfiord_cells.Rda"))
#####
...
# Load cell data (mask)
load("data/sea_ice_data/alexfiord/alexfiord_cells.Rda")
...
write.csv(sea_ice_extent, "data/sea_ice_data/alexfiord/alexfiord_sea_ice_extent.csv")
save(sea_ice_extent, file = "data/sea_ice_data/alexfiord/alexfiord_sea_ice_extent.Rda")
...
load("data/sea_ice_data/alexfiord/alexfiord_sea_ice_extent.Rda")
str(sea_ice_extent)
# Let's fix that!

# A quick hack to quickly do the conversion is by loading the CSV isntead
sea_ice_extent <- read.csv("data/sea_ice_data/alexfiord/alexfiord_sea_ice_extent.csv")
str(sea_ice_extent)
