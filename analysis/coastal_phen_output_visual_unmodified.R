...
library(MCMCglmm)
## Housekeeping
load(file = "data/coastal_phen.Rda")
load(file = "models/2021-02-01_coastal_phen_rslopes_unmodified_4models_2018-03-21.Rda")
# Extract Predictions
coastal_phen_rslopes_full_sol <- lapply(models_unmodified, function(m) m$Sol)
coastal_phen_rslopes_full_sol <- mcmc.list(coastal_phen_rslopes_full_sol[[1]],
                                           coastal_phen_rslopes_full_sol[[2]],
                                           coastal_phen_rslopes_full_sol[[3]],
                                           coastal_phen_rslopes_full_sol[[4]])
coastal_phen_rslopes_full_vcv <- lapply(models_unmodified, function(m) m$VCV)
coastal_phen_rslopes_full_vcv <- mcmc.list(coastal_phen_rslopes_full_vcv[[1]],
                                           coastal_phen_rslopes_full_vcv[[2]],
                                           coastal_phen_rslopes_full_vcv[[3]],
                                           coastal_phen_rslopes_full_vcv[[4]])
coastal_phen_rslopes_full_sol_summary <- summary(coastal_phen_rslopes_full_sol)
coastal_phen_rslopes_full_vcv_summary <- summary(coastal_phen_rslopes_full_vcv)

model_summary <- data.frame(
  snowmelt = coastal_phen_rslopes_full_sol_summary$statistics["snowmelt_rel_scaled", "Mean"],
  snowmelt_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["snowmelt_rel_scaled", "2.5%"],
  snowmelt_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["snowmelt_rel_scaled", "97.5%"],
  
  phase_temp = coastal_phen_rslopes_full_sol_summary$statistics["phase_temp_unmodified_rel_scaled", "Mean"],
  phase_temp_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["phase_temp_unmodified_rel_scaled", "2.5%"],
  phase_temp_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["phase_temp_unmodified_rel_scaled", "97.5%"],
  
  onset_ice_melt = coastal_phen_rslopes_full_sol_summary$statistics["onset_ice_melt_rel_scaled", "Mean"],
  onset_ice_melt_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["onset_ice_melt_rel_scaled","2.5%"],
  onset_ice_melt_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["onset_ice_melt_rel_scaled", "97.5%"],
  
  year = coastal_phen_rslopes_full_sol_summary$statistics["year_rel_scaled", "Mean"],
  year_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["year_rel_scaled", "2.5%"],
  year_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["year_rel_scaled", "97.5%"],
  
  site_name = coastal_phen_rslopes_full_vcv_summary$statistics["site_name", "Mean"],
  site_name_l95 = coastal_phen_rslopes_full_vcv_summary$quantiles["site_name","2.5%"],
  site_name_u95 = coastal_phen_rslopes_full_vcv_summary$quantiles["site_name", "97.5%"],
  
  plot_id = coastal_phen_rslopes_full_vcv_summary$statistics["plot_id", "Mean"],
  plot_id_l95 = coastal_phen_rslopes_full_vcv_summary$quantiles["plot_id","2.5%"],
  plot_id_u95 = coastal_phen_rslopes_full_vcv_summary$quantiles["plot_id", "97.5%"],
  
  year_fac = coastal_phen_rslopes_full_vcv_summary$statistics["year_fac", "Mean"],
  year_fac_l95 = coastal_phen_rslopes_full_vcv_summary$quantiles["year_fac","2.5%"],
  year_fac_u95 = coastal_phen_rslopes_full_vcv_summary$quantiles["year_fac", "97.5%"],
  
  site_name_year_fac = coastal_phen_rslopes_full_vcv_summary$statistics["site_name:year_fac", "Mean"],
  site_name_year_fac_l95 = coastal_phen_rslopes_full_vcv_summary$quantiles["site_name:year_fac","2.5%"],
  site_name_year_fac_u95 = coastal_phen_rslopes_full_vcv_summary$quantiles["site_name:year_fac", "97.5%"]
  
)

write.csv(model_summary, "analysis/2021_02_01_new_analysis/model_summary.csv")
...
post_dists <- data.frame(
  ...
  site_spp_phen = spp_phen_combos,
  snowmelt_mean = coastal_phen_rslopes_full_sol_summary$statistics["snowmelt_rel_scaled", "Mean"],
  snowmelt_mean_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["snowmelt_rel_scaled", "2.5%"],
  snowmelt_mean_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["snowmelt_rel_scaled", "97.5%"],
  phase_temp_mean = coastal_phen_rslopes_full_sol_summary$statistics["phase_temp_unmodified_rel_scaled", "Mean"], 
  phase_temp_mean_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["phase_temp_unmodified_rel_scaled", "2.5%"],
  phase_temp_mean_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["phase_temp_unmodified_rel_scaled", "97.5%"],
  onset_ice_melt_mean = coastal_phen_rslopes_full_sol_summary$statistics["onset_ice_melt_rel_scaled", "Mean"],
  onset_ice_melt_mean_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["onset_ice_melt_rel_scaled", "2.5%"],
  onset_ice_melt_mean_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["onset_ice_melt_rel_scaled", "97.5%"],
  year_mean = coastal_phen_rslopes_full_sol_summary$statistics["year_rel_scaled", "Mean"],
  year_mean_l95 = coastal_phen_rslopes_full_sol_summary$quantiles["year_rel_scaled", "2.5%"],
  year_mean_u95 = coastal_phen_rslopes_full_sol_summary$quantiles["year_rel_scaled", "97.5%"],
  snowmelt_spp = NA,
  snowmelt_spp_l95 = NA,
  snowmelt_spp_u95 = NA,
  phase_temp_spp = NA,
...
extract_post_dists <- function(site_spp_phen){
  ...
  snowmelt_spp = coastal_phen_rslopes_full_sol_summary$statistics[paste0("snowmelt_rel_scaled.site_spp_phen.", site_spp_phen), "Mean"]
  snowmelt_spp_l95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("snowmelt_rel_scaled.site_spp_phen.", site_spp_phen), "2.5%"]
  snowmelt_spp_u95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("snowmelt_rel_scaled.site_spp_phen.", site_spp_phen), "97.5%"]
  
  phase_temp_spp = coastal_phen_rslopes_full_sol_summary$statistics[paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen), "Mean"]
  phase_temp_spp_l95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen), "2.5%"]
  phase_temp_spp_u95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen), "97.5%"]
  
  onset_ice_melt_spp = coastal_phen_rslopes_full_sol_summary$statistics[paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen), "Mean"]
  onset_ice_melt_spp_l95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen),"2.5%"]
  onset_ice_melt_spp_u95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen), "97.5%"]
  
  year_spp = coastal_phen_rslopes_full_sol_summary$statistics[paste0("year_rel_scaled.site_spp_phen.", site_spp_phen), "Mean"]
  year_spp_l95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("year_rel_scaled.site_spp_phen.", site_spp_phen), "2.5%"]
  year_spp_u95 = coastal_phen_rslopes_full_sol_summary$quantiles[paste0("year_rel_scaled.site_spp_phen.", site_spp_phen), "97.5%"]
...
plot_spp_effect_sizes <- function(site_to_plot){
  ...
  spp_dists$site_spp_phen <- factor(as.character(spp_dists$site_spp_phen))
  ...
  ggplot(data = spp_dists, aes(x = as.integer(predictor),
    ...
    annotate("text", x = 2, y = 8, label = name_pretty, # for right aligned x = 3.4 and hjust = 1, for centre x = 2 and hjust = 0.5
...
plot_grob <- grid.arrange(ALEXFIORD_spp_effect_size_plot, 
                          ...
                          ZACKENBERG_spp_effect_size_plot,
                          layout_matrix = panel_layout)
ggsave(filename = "analysis/2021_02_01_new_analysis/coastal_spp_effect_size_plot.png", 
...
effect_sizes <- data.frame(predictor = c("Snowmelt", "Temperature", "Sea-Ice"),
                           pred_mean = c(coastal_phen_rslopes_full_sol_summary$statistics["snowmelt_rel_scaled","Mean"],
                                         coastal_phen_rslopes_full_sol_summary$statistics["phase_temp_unmodified_rel_scaled","Mean"],
                                         coastal_phen_rslopes_full_sol_summary$statistics["onset_ice_melt_rel_scaled","Mean"]),
                           pred_var = c(coastal_phen_rslopes_full_vcv_summary$statistics["snowmelt_rel_scaled:snowmelt_rel_scaled.site_spp_phen","Mean"],
                                        coastal_phen_rslopes_full_vcv_summary$statistics["phase_temp_unmodified_rel_scaled:phase_temp_unmodified_rel_scaled.site_spp_phen","Mean"],
                                        coastal_phen_rslopes_full_vcv_summary$statistics["onset_ice_melt_rel_scaled:onset_ice_melt_rel_scaled.site_spp_phen","Mean"])
                           )
...
ggsave("analysis/2021_02_01_new_analysis/coastal_phen_violin.png", violin_plot)
...
write.csv(post_dists_export[order(post_dists_export$predictor),], 
          file = "analysis/2021_02_01_new_analysis/post_dists.csv", row.names = F)
...
itex.data <- read.csv("data/phenology_data/CCIN12722_20171116_Arctic_phenology_database_1992-2014.csv")
...
plot_grob <- grid.arrange(ALEXFIORD_legend_plot, 
                          ...
                          layout_matrix = panel_layout)
ggsave(filename = "analysis/2021_02_01_new_analysis/coastal_legend.png",
       plot = plot_grob, 
       scale = 1.7, 
       width = 10, 
       height = (10/3)/2, 
