...
load(file = paste0(script_path, "models/2018-09-21_coastal_phen_rslopes_full_snowmlet_averages.Rda"))
# Extract Predictions
coastal_phen_rslopes_full_summary <- summary(coastal_phen_rslopes_full_snowmelt_averages)

model_summary <- data.frame(
  snowmelt = coastal_phen_rslopes_full_summary$solutions["snowmelt_average_rel_scaled", "post.mean"],
  snowmelt_l95 = coastal_phen_rslopes_full_summary$solutions["snowmelt_average_rel_scaled", "l-95% CI"],
  snowmelt_u95 = coastal_phen_rslopes_full_summary$solutions["snowmelt_average_rel_scaled", "u-95% CI"],
  
  phase_temp = coastal_phen_rslopes_full_summary$solutions["phase_temp_unmodified_rel_scaled", "post.mean"],
  phase_temp_l95 = coastal_phen_rslopes_full_summary$solutions["phase_temp_unmodified_rel_scaled", "l-95% CI"],
  phase_temp_u95 = coastal_phen_rslopes_full_summary$solutions["phase_temp_unmodified_rel_scaled", "u-95% CI"],
  
  onset_ice_melt = coastal_phen_rslopes_full_summary$solutions["onset_ice_melt_rel_scaled", "post.mean"],
  onset_ice_melt_l95 = coastal_phen_rslopes_full_summary$solutions["onset_ice_melt_rel_scaled","l-95% CI"],
  onset_ice_melt_u95 = coastal_phen_rslopes_full_summary$solutions["onset_ice_melt_rel_scaled", "u-95% CI"],
  
  year = coastal_phen_rslopes_full_summary$solutions["year_rel_scaled", "post.mean"],
  year_l95 = coastal_phen_rslopes_full_summary$solutions["year_rel_scaled", "l-95% CI"],
  year_u95 = coastal_phen_rslopes_full_summary$solutions["year_rel_scaled", "u-95% CI"],
  
  site_name = coastal_phen_rslopes_full_summary$Gcovariances["site_name", "post.mean"],
  site_name_l95 = coastal_phen_rslopes_full_summary$Gcovariances["site_name","l-95% CI"],
  site_name_u95 = coastal_phen_rslopes_full_summary$Gcovariances["site_name", "u-95% CI"],
  
  plot_id = coastal_phen_rslopes_full_summary$Gcovariances["plot_id", "post.mean"],
  plot_id_l95 = coastal_phen_rslopes_full_summary$Gcovariances["plot_id","l-95% CI"],
  plot_id_u95 = coastal_phen_rslopes_full_summary$Gcovariances["plot_id", "u-95% CI"],
  
  year_fac = coastal_phen_rslopes_full_summary$Gcovariances["year_fac", "post.mean"],
  year_fac_l95 = coastal_phen_rslopes_full_summary$Gcovariances["year_fac","l-95% CI"],
  year_fac_u95 = coastal_phen_rslopes_full_summary$Gcovariances["year_fac", "u-95% CI"],
  
  site_name_year_fac = coastal_phen_rslopes_full_summary$Gcovariances["site_name:year_fac", "post.mean"],
  site_name_year_fac_l95 = coastal_phen_rslopes_full_summary$Gcovariances["site_name:year_fac","l-95% CI"],
  site_name_year_fac_u95 = coastal_phen_rslopes_full_summary$Gcovariances["site_name:year_fac", "u-95% CI"]
)

write.csv(model_summary, paste0(script_path, "/snowmelt_averages/model_summary.csv"))
...
post_dists <- data.frame(
  ...
  site_spp_phen = spp_phen_combos,
  snowmelt_mean = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"snowmelt_average_rel_scaled"]),
  snowmelt_mean_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"snowmelt_average_rel_scaled"], 0.05)),
  snowmelt_mean_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"snowmelt_average_rel_scaled"], 0.95)),
  phase_temp_mean = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"phase_temp_unmodified_rel_scaled"]), 
  phase_temp_mean_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"phase_temp_unmodified_rel_scaled"], 0.05)),
  phase_temp_mean_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"phase_temp_unmodified_rel_scaled"], 0.95)),
  onset_ice_melt_mean = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"onset_ice_melt_rel_scaled"]),
  onset_ice_melt_mean_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"onset_ice_melt_rel_scaled"], 0.05)),
  onset_ice_melt_mean_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"onset_ice_melt_rel_scaled"], 0.95)),
  year_mean = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"year_rel_scaled"]),
  year_mean_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"year_rel_scaled"], 0.05)),
  year_mean_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,"year_rel_scaled"], 0.95)),
  snowmelt_spp = NA,
  snowmelt_spp_l95 = NA,
  snowmelt_spp_u95 = NA,
  phase_temp_spp = NA,
...
extract_post_dists <- function(site_spp_phen){
  ...
  snowmelt_spp = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("snowmelt_average_rel_scaled.site_spp_phen.", site_spp_phen)])
  snowmelt_spp_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("snowmelt_average_rel_scaled.site_spp_phen.", site_spp_phen)], 0.05))
  snowmelt_spp_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("snowmelt_average_rel_scaled.site_spp_phen.", site_spp_phen)], 0.95))
  
  phase_temp_spp = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen)])
  phase_temp_spp_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen)], 0.05))
  phase_temp_spp_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("phase_temp_unmodified_rel_scaled.site_spp_phen.", site_spp_phen)], 0.95))
  
  onset_ice_melt_spp = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen)])
  onset_ice_melt_spp_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen)], 0.05))
  onset_ice_melt_spp_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("onset_ice_melt_rel_scaled.site_spp_phen.", site_spp_phen)], 0.95))
  
  year_spp = mean(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("year_rel_scaled.site_spp_phen.", site_spp_phen)])
  year_spp_l95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("year_rel_scaled.site_spp_phen.", site_spp_phen)], 0.05))
  year_spp_u95 = as.numeric(quantile(coastal_phen_rslopes_full_snowmelt_averages$Sol[,paste0("year_rel_scaled.site_spp_phen.", site_spp_phen)], 0.95))
...
plot_grob <- grid.arrange(ALEXFIORD_spp_effect_size_plot, 
                          ...
                          ZACKENBERG_spp_effect_size_plot,
                          layout_matrix = panel_layout)
ggsave(filename = paste0(script_path, "/snowmelt_averages/coastal_spp_effect_size_plot.png"), 
...
effect_sizes <- data.frame(predictor = c("Snowmelt", "Temperature", "Sea-Ice"),
                           pred_mean = c(summary(coastal_phen_rslopes_full_snowmelt_averages)$solutions["snowmelt_average_rel_scaled","post.mean"],
                                         summary(coastal_phen_rslopes_full_snowmelt_averages)$solutions["phase_temp_unmodified_rel_scaled","post.mean"],
                                         summary(coastal_phen_rslopes_full_snowmelt_averages)$solutions["onset_ice_melt_rel_scaled","post.mean"]),
                           pred_var = c(summary(coastal_phen_rslopes_full_snowmelt_averages)$Gcovariances["snowmelt_average_rel_scaled:snowmelt_average_rel_scaled.site_spp_phen","post.mean"],
                                        summary(coastal_phen_rslopes_full_snowmelt_averages)$Gcovariances["phase_temp_unmodified_rel_scaled:phase_temp_unmodified_rel_scaled.site_spp_phen","post.mean"],
                                        summary(coastal_phen_rslopes_full_snowmelt_averages)$Gcovariances["onset_ice_melt_rel_scaled:onset_ice_melt_rel_scaled.site_spp_phen","post.mean"])
)
...
ggsave(paste0(script_path, "/snowmelt_averages/coastal_phen_violin.png"), violin_plot)
...
write.csv(post_dists_export[order(post_dists_export$predictor),], 
          file = paste0(script_path, "/snowmelt_averages/post_dists.csv"), row.names = F)
