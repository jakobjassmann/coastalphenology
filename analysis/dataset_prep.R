...
# Housekeeping
script_path <- "scripts/users/jassmann/phenology/"
sites <- c("alexfiord", "barrow", "qhi", "zackenberg") # NB lower case for objects

# Import phenology data
alexfiord_phen <- read.csv("scripts/users/jassmann/phenology/phenology_data/alexfiord/alexfiord_phen.csv")
barrow_phen <- read.csv("scripts/users/jassmann/phenology/phenology_data/barrow/barrow_phen.csv")
qhi_phen <- read.csv("scripts/users/jassmann/phenology/phenology_data/qhi/qhi_phen.csv")
zackenberg_phen <- read.csv("scripts/users/jassmann/phenology/phenology_data/zackenberg/zackenberg_phen.csv")
...
# Import sea ice data
alexfiord_sea_ice <- read.csv("scripts/users/jassmann/phenology/sea_ice_data/alexfiord/alexfiord_sea_ice_extent.csv")
barrow_sea_ice <- read.csv("scripts/users/jassmann/phenology/sea_ice_data/barrow/barrow_sea_ice_extent.csv")
qhi_sea_ice <- read.csv("scripts/users/jassmann/phenology/sea_ice_data/qhi/qhi_sea_ice.csv")
zackenberg_sea_ice <- read.csv("scripts/users/jassmann/phenology/sea_ice_data/zackenberg/zackenberg_sea_ice_extent.csv")
...
# export data
save(coastal_phen, file = paste0(script_path, "coastal_phenology/coastal_phen.Rda"))
write.csv(coastal_phen, file = paste0(script_path, "coastal_phenology/coastal_phen.csv"), row.names = F)
